                ...
                conrad.addJob({
                    ...
                    job: self.forceatlas2.atomicGo,
                        ...
                        if(self.graph.nodes().length>0){
                            ...
                            var nodesOnGraph=self.graph.nodes();
                            var conId=self.renderers[0].conradId;
                            var mapX=self.graph.nodes().map(function(o){
                                return o['renderer'+conId+':x'];
                            })
                            
                            var mapY=self.graph.nodes().map(function(o){
                            ...
                            for(var i=0,x,y,z,a,b,c;i<nodesOnGraph.length;i++){
                                ...
                                c=Math.round((16-x+z)/2).toString(16);
